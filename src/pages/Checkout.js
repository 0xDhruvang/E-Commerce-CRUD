...
function Checkout() {
    ...
    return(
      ...
      {addresses.map((address) => (
        <li key={address.phone} className="flex justify-between px-5 gap-x-6 py-5 border-solid border-2 border-gray-200">
  ...
  <div className="mx-auto mt-12 bg-white max-w-7xl px-0 sm:px-0 lg:px-0">
     <h1 className="text-4xl my-5 py-5 font-bold tracking-tight text-gray-900">Cart</h1>
      ...
      {/* Second Component: Subtotal and Checkout */}
      <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
        <div className="flex justify-between text-base font-medium text-gray-900">
          <p>Subtotal</p>
          <p>$262.00</p>
